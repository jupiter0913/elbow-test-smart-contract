...
abstract contract TokenFaucet is ERC20, Ownable {
    ...
    function faucet() external {
        ...
        require(
            faucetTotal >= giveawayTotal + faucetAmount,
            "Faucet total is running out now."
        );
        require(
            block.timestamp - userLastTime[msg.sender] > interval,
            "Faucet interval is not expired."
        );
